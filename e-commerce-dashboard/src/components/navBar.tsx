...
function SideBar() {
  ...
  return (
    <nav>
      <div className="nav-items flex justify-between px-4 border-gray-200 shadow-md">
        <img src={"./logo.png"} height={110} width={110} alt="Site logo image" />
        <div className='flex items-center pl-4 gap-3 mr-2'>
          ...
          <button className='relative left-2 p-2 rounded-full focus:outline-none focus: border-violet-500 focus:ring-2 focus:ring-violet-500'>
          ...
          >
            <MenuItem onClick={handleClose}>
              <span className='w-[180px] h-[24px] text-sm text-gray-400 flex items-center'>Your Profile</span>
            </MenuItem>
            <MenuItem onClick={handleClose}>
              <span className='w-[180px] h-[24px] text-sm text-gray-400 flex items-center'>Setting</span>
            </MenuItem>
            <MenuItem onClick={handleClose}>
              <span className='w-[180px] h-[24px] text-sm text-gray-400 flex items-center'>Sign Out</span>
            </MenuItem>
          </Menu>
        </div>
      </div>
